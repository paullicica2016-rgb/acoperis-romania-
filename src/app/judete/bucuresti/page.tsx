...
const stats = [
  { icon: Home, value: "200+", label: "Acoperisuri in Bucuresti" },
...
const portofoliu = [
  { src: "/images/dragos/poza-5.jpeg", label: "Sector 1" },
  { src: "/images/dragos/acoperisuri-noi.jpeg", label: "Sector 2" },
  { src: "/images/projects/renovare-final.jpeg", label: "Sector 3" },
  { src: "/images/projects/reparatii-2.webp", label: "Sector 4" },
];
    ...
    <>
      ...
      <section className="relative bg-[#051D3E] text-white pt-16 pb-0 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/hero-reparatii.webp" alt="Acoperisuri Bucuresti" fill className="object-cover" priority sizes="100vw" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 pb-24 pt-8">
          <nav className="flex items-center gap-2 text-sm text-white/60 mb-6">
            ...
            <span className="text-white/40">›</span>
            <span className="text-white">Bucuresti</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 leading-tight">
                Servicii complete de acoperisuri in Bucuresti
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed text-sm">
                <p>Acoperim intreaga Capitala cu servicii complete de constructie, reparatii si renovare acoperisuri. Echipele noastre sunt mobile si se deplaseaza in orice sector al Bucurestiului.</p>
            ...
            <div className="space-y-5">
              <div className="bg-white rounded-2xl border border-gray-200 p-6">
                <h3 className="font-bold text-gray-900 text-sm uppercase tracking-wide mb-4 flex items-center gap-2">
                  <MapPin size={14} className="text-[#0d1547]" /> Sectoare deservite
                </h3>
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="bg-gray-100 text-gray-500 text-xs font-medium px-3 py-1.5 rounded-full">+ toate zonele</span>
                </div>
              </div>
              <div className="bg-[#051D3E] rounded-2xl p-6 text-white">
                <h3 className="font-bold text-lg mb-2">Evaluare Gratuita in Bucuresti</h3>
                <p className="text-white/60 text-sm mb-5">Venim la fata locului oriunde in Capitala. Fara costuri de deplasare, fara obligatii.</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold text-gray-900">Portofoliu Bucuresti</h2>
          </div>
      ...
      <section className="py-20 bg-[#0d1547]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-white">Servicii in Bucuresti</h2>
          </div>
      ...
      <section className="py-20 bg-[#0d1547]">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ai nevoie de un acoperis in Bucuresti?
          </h2>
