...
export default function ValceaPage() {
  return (
    <>
      <BreadcrumbSchema items={[{"name":"Acasa","url":"https://reparatiipro.ro/"},{"name":"Judete","url":"https://reparatiipro.ro/judete"},{"name":"Valcea","url":"https://reparatiipro.ro/judete/valcea"}]} />
      {/* Hero */}
