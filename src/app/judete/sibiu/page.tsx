...
export const metadata: Metadata = {
  ...
  description: "Acoperisuri Sibiu si judetul Sibiu. Montaj si reparatii acoperis in Sibiu, Medias, Cisnadie, Saliste. Firma specializata, garantie scrisa. Suna 0750 771 028.",
      ...
      <section className="py-16 bg-gray-50"><div className="max-w-7xl mx-auto px-4"><div className="grid lg:grid-cols-2 gap-12 items-start">
        <div>
          ...
          <div className="space-y-4 text-gray-600 leading-relaxed text-sm">
            ...
            <p>Daca ai nevoie de reparatii acoperis in Sibiu sau de un acoperis nou in judetul Sibiu, suna acum la <strong>0750 771 028</strong>. Venim gratuit la fata locului si iti dam un deviz clar fara costuri ascunse.</p>
          </div>
