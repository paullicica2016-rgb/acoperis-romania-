...
export const metadata: Metadata = {
  ...
  description: "Acoperisuri Deva si judetul Hunedoara. Montaj acoperis Deva, reparatii acoperis Petrosani, Orastie, Brad, Simeria. Firma locala 15+ ani, garantie scrisa. Suna 0735 097 539.",
...
export default function HunedoaraPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "HomeAndConstructionBusiness", name: "Acoperisuri Pro — Hunedoara", url: "https://montajacoperispro.ro/judete/hunedoara", telephone: "+40735097539", email: "montajacoperispro@gmail.com", areaServed: ["Deva", "Hunedoara", "Petrosani", "Orastie", "Brad", "Simeria"], description: "Firma locala cu 15+ ani experienta in acoperisuri in Deva si judetul Hunedoara." }) }} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed text-sm">
                ...
                <p>Pentru montaj acoperis in Deva sau reparatii urgente in judetul Hunedoara, suna acum la <strong>0735 097 539</strong>. Venim gratuit la fata locului, evaluam si iti dam un deviz clar fara costuri ascunse.</p>
              </div>
