...
const orase = [
  "Deva", "Hunedoara", "Petrosani", "Orastie",
  "Brad", "Simeria", "Hateg", "Lupeni",
  "Vulcan", "Petrila", "Calan", "Geoagiu",
];
...
export default function HunedoaraPage() {
  return (
    <>
      <BreadcrumbSchema items={[{"name":"Acasa","url":"https://reparatiipro.ro/"},{"name":"Judete","url":"https://reparatiipro.ro/judete"},{"name":"Hunedoara","url":"https://reparatiipro.ro/judete/hunedoara"}]} />
      {/* ── Hero cu val ── */}
      <section className="relative bg-[#051D3E] text-white pt-16 pb-0 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/dragos/poza-5.jpeg" alt="Acoperisuri Hunedoara" fill className="object-cover" priority sizes="100vw" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 pb-24 pt-8">
          <nav className="flex items-center gap-2 text-sm text-white/60 mb-6">
            ...
            <span className="text-white/40">›</span>
            <span className="text-white">Hunedoara</span>
          </nav>
          <div className="flex items-center gap-2 mb-5">
            <span className="inline-flex items-center gap-1.5 bg-white/15 border border-white/20 text-white/90 text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full">
              <MapPin size={11} /> Judetul Hunedoara
            </span>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-5 max-w-2xl">
            Acoperisuri in<br />Judetul Hunedoara
          </h1>
          <div className="w-12 h-1 bg-[#E53935] rounded mb-6" />
          <p className="text-white/75 text-lg leading-relaxed mb-8 max-w-xl">
            Firma locala cu peste 15 ani de activitate in Hunedoara. Constructie, reparatii, renovari — in Deva, Petrosani, Orastie, Brad si in toate localitatile din judet.
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            {/* Text */}
            <div>
              <span className="text-[#0d1547] font-semibold text-sm uppercase tracking-wider block mb-3">Zona noastra principala</span>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 leading-tight">
                Acasa in Hunedoara de peste 15 ani
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed text-sm">
                <p>
                  Hunedoara este judetul in care ne-am construit reputatia. Nu suntem o firma venita din alt capat al tarii — suntem de aici, cunoastem constructiile locale, conditiile climatice si oamenii cu care lucram.
                </p>
                <p>
                  Zona montana a Hunedoarei — Valea Jiului, Hateg, Retezat — impune acoperisuri dimensionate pentru sarcini mari de zapada si vant. Zona de campie din jurul Devei si Simeria are alte cerinte. Stim sa adaptam solutia tehnica la fiecare locatie.
                </p>
                <p>
                  Timp de raspuns minim, deplasare gratuita pentru evaluare si preturi corecte — fara majorari pentru distanta in cadrul judetului. Asa lucram in Hunedoara de 15 ani.
                </p>
              </div>
              <ul className="mt-6 space-y-2">
                {[
                  "Firma inregistrata si activa in judetul Hunedoara",
                  "Cunoastem specificul constructiilor locale",
                  "Solutii adaptate pentru zone montane si campie",
                  "Timp de raspuns minim — suntem localnici",
                  "Deplasare si evaluare gratuita in tot judetul",
            ...
            <div className="space-y-5">
              ...
              <div className="bg-[#051D3E] rounded-2xl p-6 text-white">
                <h3 className="font-bold text-lg mb-2">Evaluare Gratuita in Hunedoara</h3>
      ...
      {/* ── Portofoliu Hunedoara ── */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            <span className="text-[#0d1547] font-semibold text-sm uppercase tracking-wider block mb-3">Lucrari locale</span>
            <h2 className="text-3xl font-bold text-gray-900">Portofoliu Hunedoara</h2>
          </div>
      ...
      <section className="py-20 bg-[#0d1547]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-white">Servicii in Judetul Hunedoara</h2>
          </div>
      ...
      <section className="py-20 bg-[#0d1547]">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ai nevoie de un acoperis in Hunedoara?
          </h2>
          <p className="text-white/70 text-lg mb-10">
            Suntem localnici. Venim rapid, lucram serios, garantam rezultatul.
          </p>
