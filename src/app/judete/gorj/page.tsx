...
const stats = [
  { icon: Home, value: "200+", label: "Acoperisuri in Gorj" },
...
const orase = [
  "Targu Jiu", "Motru", "Rovinari", "Tismana", "Bumbesti-Jiu",
  "Novaci", "Turceni", "Tirgu Carbunesti", "Pestisani", "Lelesti",
];
...
const portofoliu = [
  { src: "/images/dragos/poza-4.jpeg", label: "Targu Jiu" },
  { src: "/images/projects/tigla-metalica-2-new.jpeg", label: "Motru" },
  { src: "/images/projects/tigla-ceramica-vila.jpeg", label: "Rovinari" },
  { src: "/images/dragos/renovari-4.jpeg", label: "Novaci" },
];
    ...
    <>
      ...
      <section className="relative bg-[#051D3E] text-white pt-16 pb-0 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/dragos/poza-4.jpeg" alt="Acoperisuri Gorj" fill className="object-cover" priority sizes="100vw" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 pb-24 pt-8">
          <nav className="flex items-center gap-2 text-sm text-white/60 mb-6">
            ...
            <span className="text-white/40">›</span>
            <span className="text-white">Gorj</span>
          </nav>
          <div className="flex items-center gap-2 mb-5">
            <span className="inline-flex items-center gap-1.5 bg-white/15 border border-white/20 text-white/90 text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full">
              <MapPin size={11} /> Judetul Gorj
            </span>
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-5 max-w-2xl">
            Acoperisuri in<br />Judetul Gorj
          </h1>
          <div className="w-12 h-1 bg-[#E53935] rounded mb-6" />
          <p className="text-white/75 text-lg leading-relaxed mb-8 max-w-xl">
            Servicii profesionale de constructie, reparatii si renovare acoperisuri in judetul Gorj. Evaluare gratuita, garantie scrisa, echipe specializate.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 leading-tight">
                Servicii complete de acoperisuri in Gorj
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed text-sm">
                <p>Acoperim intregul judet Gorj cu servicii complete de constructie, reparatii si renovare acoperisuri. Echipele noastre sunt mobile si se deplaseaza in orice localitate din judet.</p>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-[#051D3E] rounded-2xl p-6 text-white">
                <h3 className="font-bold text-lg mb-2">Evaluare Gratuita in Gorj</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold text-gray-900">Portofoliu Gorj</h2>
          </div>
      ...
      <section className="py-20 bg-[#0d1547]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-white">Servicii in Judetul Gorj</h2>
          </div>
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/cta.webp" alt="Acoperisuri Gorj" fill className="object-cover" sizes="100vw" />
          <div className="absolute inset-0 bg-[#0d1547]/85" />
        </div>
        <div className="relative max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ai nevoie de un acoperis in Gorj?
          </h2>
