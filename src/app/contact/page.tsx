...
export const metadata: Metadata = {
  ...
  description: "Contacteaza Reparatii Pro pentru oferta gratuita montaj si reparatii acoperisuri. Tel: 0754 456 844. Deplasare gratuita Bucuresti si 13 judete.",
};
    ...
    <>
      ...
      <section className="relative -mt-12 z-10 max-w-6xl mx-auto px-4 mb-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <a href="tel:0754456844" className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 text-center hover:border-accent/30 transition-colors group">
            ...
            <p className="text-sm text-gray-500">0754 456 844</p>
          </a>
