...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Firma cu peste 15 ani experienta in montaj si reparatii acoperisuri. Tigla metalica, ceramica, tabla faltuita. Hunedoara si judete invecinate. Suna 0754 456 844.",
    images: [
      {
