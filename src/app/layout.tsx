...
export const metadata: Metadata = {
  ...
  title: {
    default: "Montaj si Reparatii Acoperisuri | Reparatii Pro - Firma Acoperisuri Bucuresti",
  ...
  keywords: [
    ...
    "jgheaburi burlane", "interventii urgenta acoperis", "reparatii acoperis Bucuresti",
    "montaj tigla metalica", "montaj tigla ceramica", "acoperis pret", "firma montaj acoperis",
    "reparatii acoperis Ilfov", "reparatii acoperis Constanta", "reparatii acoperis Prahova", "reparatii acoperis Iasi",
    "acoperis nou", "invelitori acoperis", "Reparatii Pro",
  ],
  authors: [{ name: "Reparatii Pro" }],
  creator: "Reparatii Pro",
  publisher: "Reparatii Pro",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Reparatii Pro - Montaj si Reparatii Acoperisuri Profesionale",
      },
    ],
  },
  twitter: {
    ...
    title: "Montaj si Reparatii Acoperisuri | Reparatii Pro",
    description: "Firma cu 15+ ani experienta. Montaj acoperisuri, reparatii, renovari. Bucuresti si 13 judete.",
