...
export const metadata: Metadata = {
  ...
  description: "Interventii urgenta 24/7 pentru acoperisuri avariate — furtuna, vant, grindina. Echipe mobile, raspuns rapid, securizare imediata. Suna acum 0750 771 028.",
    ...
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 pb-24 pt-8">
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a href="tel:0750771028" className="inline-flex items-center justify-center gap-2 bg-[#E53935] text-white px-7 py-3.5 rounded-full font-bold text-sm hover:bg-red-700 transition-colors">
                <Phone size={16} /> Suna Acum — 0750 771 028
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="bg-red-50 border border-red-200 rounded-2xl p-6 flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
            ...
            <a href="tel:0750771028" className="inline-flex items-center gap-2 bg-[#E53935] text-white px-6 py-3 rounded-full font-bold text-sm hover:bg-red-700 transition-colors shrink-0">
              0750 771 028
            </a>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-5">
              <div className="bg-[#E53935] rounded-2xl p-6 text-white">
                ...
                <a href="tel:0750771028" className="flex items-center justify-center gap-2 bg-white text-[#E53935] py-3.5 rounded-xl font-bold text-sm hover:bg-gray-100 transition-colors mb-3">
            ...
            {[
              {
                ...
                a: "In zona Hunedoara si judete invecinate ajungem in maxim 1-3 ore. Suntem disponibili 24/7, inclusiv sambata, duminica si sarbatori legale. Sunati 0750 771 028 si va confirmam ora sosirii.",
              },
              {
      ...
      <section className="py-20 bg-[#0d1547]">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <a href="tel:0750771028" className="inline-flex items-center justify-center gap-2 bg-[#E53935] text-white px-10 py-4 rounded-full text-lg font-bold hover:bg-red-700 transition-colors">
            <Phone size={20} /> 0750 771 028 — Urgenta
          </a>
        </div>
      </section>
    </>
